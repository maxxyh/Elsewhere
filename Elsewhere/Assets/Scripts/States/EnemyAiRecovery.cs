...
public class EnemyAiRecovery : EnemyState
{
    ...
    {
        int[][] proximityList = new int[map.mapSize.x][];
        for (int index = 0; index < map.mapSize.x; index++)
        {
            proximityList[index] = new int[map.mapSize.y];
        }

...
namespace RTS_Cam
{
    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void MovementTab()
        {
            ...
            {
                camera.screenEdgePercentage = EditorGUILayout.FloatField("Screen edge border percentage: ", camera.screenEdgePercentage);
            ...
            if (camera.limitMap)
            {
                camera.limitX = EditorGUILayout.FloatField("MapX Limit (half-size): ", camera.limitX);
                camera.limitY = EditorGUILayout.FloatField("MapY Limit (half-size): ", camera.limitY);
                camera.limitOffSet= EditorGUILayout.Vector2Field("Limit offSet: ", camera.limitOffSet);
            }
